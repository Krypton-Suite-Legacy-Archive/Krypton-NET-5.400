...
namespace KryptonExplorer
{
    public partial class Form1 : KryptonForm
    {
        ...
        {
            Process.Start(@"https://www.somsubhra.com/github-release-stats/?username=Wagnerp&repository=Krypton-NET-5.400");
        }
        ...
        {
            Process.Start("https://wagnerp.github.io/Krypton-NET-5.400/Help/Output/index.html");
        }

        private void kbtnChangelog_Click(object sender, EventArgs e)
        {
            Process.Start("https://wagnerp.github.io/Krypton-NET-5.400/");
        }
